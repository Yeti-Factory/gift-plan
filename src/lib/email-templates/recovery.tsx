...
export const RecoveryEmail = ({ siteName, confirmationUrl }: RecoveryEmailProps) => (
  <GiftPlanHtml preview={`Réinitialisez votre mot de passe pour ${siteName}`}>
    ...
    <Text style={text}>
      Nous avons reçu une demande de réinitialisation de votre mot de passe pour {siteName}. Cliquez
    ...
    <Text style={{ ...footer, marginTop: "32px" }}>
      Si vous n'avez pas demandé cette réinitialisation, vous pouvez ignorer cet email en toute
      sécurité. Votre mot de passe ne sera pas modifié.
    </Text>
  </GiftPlanHtml>
);
