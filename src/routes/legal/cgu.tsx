  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CGU — Gift-Plan" },
      {
        ...
        content: "Conditions générales d'utilisation du service Gift-Plan.",
      },
  ...
  return (
    <LegalLayout title="Conditions générales d'utilisation" updated="18 juillet 2026">
      ...
      <p>
        ...
        effectuée depuis votre compte. Vous pouvez supprimer votre compte à tout moment depuis
        l'onglet « Compte ».
      </p>
      ...
      <p>
        Chaque cercle est administré par son créateur, qui peut nommer d'autres administrateurs. Les
        administrateurs peuvent inviter, retirer ou promouvoir des membres. Yeti Factory SARL
        n'intervient pas dans la modération interne des cercles, sauf en cas de contenu
        manifestement illicite signalé à{" "}
      ...
      <p>
        ...
        pour assurer la disponibilité et la sécurité du service, sans garantie de continuité
        absolue. Des interruptions pour maintenance ou raison technique sont possibles.
      </p>

      <h2 className="text-lg font-semibold mt-6">7. Responsabilité</h2>
      <p>
        Dans les limites autorisées par la loi, la responsabilité de Yeti Factory SARL ne saurait
        être engagée pour des dommages indirects, ni pour la perte de contenus résultant de la
        suppression d'un compte par son utilisateur.
      </p>

      <h2 className="text-lg font-semibold mt-6">8. Résiliation</h2>
      <p>
        Vous pouvez cesser d'utiliser le service à tout moment et supprimer votre compte. Yeti
        Factory SARL peut suspendre ou résilier un compte en cas de violation des présentes CGU,
