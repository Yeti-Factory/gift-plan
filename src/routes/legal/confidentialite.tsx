...
export const Route = createFileRoute("/legal/confidentialite")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Comment Gift-Plan collecte, utilise et protège vos données personnelles.",
      },
...
function Confidentialite() {
  return (
    <LegalLayout title="Politique de confidentialité" updated="18 juillet 2026">
      <p>
        Cette page est maintenue par Yeti Factory SARL et décrit comment Gift-Plan collecte et
        utilise vos données personnelles, conformément au Règlement (UE) 2016/679 (RGPD) et à la loi
      ...
      <ul className="list-disc pl-5 space-y-1">
        <li>
          <strong>Compte</strong> : adresse email, mot de passe (chiffré), nom d'affichage.
        </li>
        <li>
          <strong>Contenu que vous créez</strong> : cercles, listes de cadeaux, titres, liens,
          notes, images téléversées, réservations.
        </li>
        <li>
          <strong>Journaux techniques</strong> : adresse IP, journaux d'accès et d'erreurs,
          strictement pour la sécurité et le débogage.
        </li>
      </ul>
      ...
      <ul className="list-disc pl-5 space-y-1">
        <li>
          Fournir le service (exécution du contrat) : gérer votre compte, vos cercles, vos listes et
          vos réservations.
        </li>
        <li>
          Sécurité et prévention des abus (intérêt légitime) : rate-limiting, détection des
          tentatives d'intrusion.
        </li>
        <li>
          Communication de service (exécution du contrat) : emails de confirmation et de
          réinitialisation de mot de passe.
        </li>
      </ul>
      <p>
        Aucune donnée n'est utilisée à des fins publicitaires. Aucun traceur publicitaire tiers
        n'est déposé.
      </p>
      ...
      <p>
        Certains sous-traitants peuvent traiter des données hors Union européenne. Ces transferts
      ...
      <ul className="list-disc pl-5 space-y-1">
        <li>
          Compte et contenus : tant que votre compte est actif. La suppression de votre compte
          (depuis l'onglet « Compte ») entraîne l'effacement immédiat de vos données personnelles et
          le transfert ou la suppression des cercles dont vous êtes créateur.
        </li>
      ...
      <p>
        ...
        d'opposition et de portabilité. Vous pouvez exercer ces droits en écrivant à{" "}
        <a href="mailto:office@yeti-factory.com" className="text-primary underline">
          office@yeti-factory.com
        </a>
