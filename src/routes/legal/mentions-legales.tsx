...
export const Route = createFileRoute("/legal/mentions-legales")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Éditeur, hébergement et contact du service Gift-Plan." },
...
function MentionsLegales() {
  return (
    <LegalLayout title="Mentions légales" updated="18 juillet 2026">
      ...
      <p>
        Gift-Plan est édité par <strong>Yeti Lab</strong>, marque commerciale de <strong>Yeti Factory SARL</strong>.
        <br />Siège social : 18bis route de Bû, 78550 Houdan, France.
        <br />Contact : <a href="mailto:office@yeti-factory.com" className="text-primary underline">office@yeti-factory.com</a>
        <br />Directeur de la publication : Yovan Nalovic.
      </p>

      <h2 className="text-lg font-semibold mt-6">Hébergement</h2>
      <p>
        L'application est hébergée par <strong>OVH SAS</strong>, 2 rue Kellermann, 59100 Roubaix, France
        (<a href="https://www.ovhcloud.com" className="text-primary underline" rel="noreferrer" target="_blank">ovhcloud.com</a>).
      </p>
      ...
      <ul className="list-disc pl-5 space-y-1">
        ...
        <li><strong>Resend</strong> — envoi des emails transactionnels (confirmation, réinitialisation de mot de passe).</li>
        <li><strong>Lovable AI</strong> — récupération des aperçus produits (image et titre) à partir des liens ajoutés.</li>
      </ul>

      <h2 className="text-lg font-semibold mt-6">Propriété intellectuelle</h2>
      <p>
        L'ensemble des éléments du service (marque, interface, code) est la propriété de Yeti Factory SARL, sauf mention contraire.
