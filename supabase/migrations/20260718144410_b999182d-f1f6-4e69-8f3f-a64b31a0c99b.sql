-- Apply supabase/migrations/20260718143000_profile_centric_model.sql (already merged, not yet applied to DB)
DO $$ BEGIN
...
REVOKE ALL ON FUNCTION public.set_gift_reservation(uuid, text, uuid) FROM PUBLIC, anon, authenticated;
